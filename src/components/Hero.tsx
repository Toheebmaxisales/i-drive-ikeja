      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-white text-sm font-medium">Premium Car Rental Service</span>
          </div>

          {/* Main Headline */}
          <h1 className="font-poppins font-bold text-4xl md:text-6xl lg:text-7xl text-white mb-6 leading-tight">
            Drive Your Dreams with{' '}
            <span className="text-soft-gold">Luxury</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            Experience the ultimate in comfort and style with our premium fleet of luxury vehicles
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <button className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-deep-blue-black transition-all duration-300">
              View Fleet
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-300">Insured Fleet</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center mb-2">
